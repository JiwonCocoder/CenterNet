...
# splits=['train']
splits = ['train_Aug_tilt_new', 'val_Aug_tilt_new']
# splits = ['new_2']
...
for split in splits:
    ...
    for line in image_set:  # train.txt에 있는 line을 str로 하나씩 읽어들임
        ...
        image_info = {'file_name': str(int(image_id)-10335) +".jpg" ,
                      'id': int(image_id)-10335,
        ...
        for ann_ind, txt in enumerate(anns):  # 한줄씩 처리한다는 의미: ann_ind는 object 갯수에 대한 index.
            ...
            if( 0<ct3d_to_ct2d[0][0] < width -5 ) and (0<ct3d_to_ct2d[0][1] < height -5):
                ...
                #             (0, 255, 0), 1)
                ann = {'image_id': int(image_id) - 10335,
                ...
                # cv2.waitKey()
            # cv2.imwrite('C:\\obj_detection\\CenterNet-master\\CenterNet-master\\data\\SUNRGBD\\resultImages_Aug2\\'+str(image_id)+'.jpg',image)

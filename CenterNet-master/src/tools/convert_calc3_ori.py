    ...
    for image_id in f_list:
        ...
        for txt in anns_list:
            ...
            if cat_id == 'table' or cat_id == 'desk':
                cv2.circle(img, (int(loc_2d[0][0]), int(loc_2d[0][1])), 5, (0, 0, 0),
                           -1)
                rot_end_x = loc_2d[0][0] + np.cos(gt_label_list[2]) * 50
                rot_end_y = loc_2d[0][1] - np.sin(gt_label_list[2]) * 50
                cv2.arrowedLine(img, (int(loc_2d[0][0]), int(loc_2d[0][1])),
                                (int(rot_end_x), int(rot_end_y)), (0, 0, 0), 2)
                ...
                # show : class
                _x1 = int(loc_2d[0][0]) - 30
                _y1 = int(loc_2d[0][1]) -40
        ...
        for txt_3d in pd_list:
            ...
            if cat_pd == 'table' or cat_pd == 'desk':
                ...
                cv2.arrowedLine(img, (int(loc_2d_pd[0][0]), int(loc_2d_pd[0][1])),
                ...
                cv2.putText(img, yaw_pd,
                            (int(loc_2d_pd[0][0]) + 5, int(loc_2d_pd[0][1]) + 10),
                            cv2.FONT_HERSHEY_COMPLEX, 0.7,
                            cl, 2)
                # cv2.putText(img, yaw_gt,
                #             (int(loc_2d[0][0]) - 25, int(loc_2d[0][1]) - 25),

        ...
        for key in pd_dict_per_img:
            ...
            if len(key_val_pd_list)> 0:
                ...
                for pd in pdKey_gtIOU_dict:
                    ...
                    box_3d_pd = compute_box_tilt_pd3(dim_w_pd_eval, loc_w_gt_eval, yaw_pd_eval, Rtilt)
                    box_2d_pd = project_to_image(box_3d_pd, calib)
                    draw_box_3d(img, box_2d_pd, (0, 0, 255))
                    ...
                    # print(bbox2D_gt_eval)
            cv2.imwrite(
                'C:\\obj_detection\\CenterNet-master\\CenterNet-master\\data\\SUNRGBD\\resultImages_tilt_hm\\' + str(
                    image_id) + '.jpg', img)

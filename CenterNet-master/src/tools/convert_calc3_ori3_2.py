    ...
    for image_id in f_list:
        ...
        for txt in anns_list:
            ...
            if cat_id == 'table':
                ...
                _x1 = int(rot_end_x) + 15
                _y1 = int(rot_end_y ) -5
                _x2 = _x1 + labelSize[0][0] + 15 + 10
                _y2 = _y1 + labelSize[0][1] + 10 + 10
                ...
                # cv2.putText(img, yaw_gt,
                #             (int(rot_end_x) + 15, int(rot_end_y) + 20),
        ...
        for txt_3d in pd_list:
            ...
            if cat_pd == 'table' or cat_pd == 'desk':
                ...
                # show : class
                _x1 = int(rot_end_x_pd) + 10
                _y1 = int(rot_end_y_pd ) - 3
                _x2 = _x1 + labelSize[0][0] + 15 + 10 + 10
                _y2 = _y1 + labelSize[0][1] + 10 + 10
                # cv2.rectangle(img , (_x1, _y1), (_x2, _y2), (255, 255, 255), cv2.FILLED)
                #
                # cv2.putText(img, yaw_pd,
                #             (int(rot_end_x_pd) + 10, int(rot_end_y_pd) + 20),
                #             cv2.FONT_HERSHEY_COMPLEX, 1,
                #             cl, 2)
                # cv2.putText(img, yaw_gt,

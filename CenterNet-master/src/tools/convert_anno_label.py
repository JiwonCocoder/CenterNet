...
pd_dir = DATA_PATH + 'label_pd_Aug_0.3/'
# pd_dir = DATA_PATH + 'label_pd_2d_from_3d_tilt_0.3/'
...
for split in splits:
    ...
    error_mean_dict_per_cat = {"bathtub": [], "bed": [], "bookshelf": [],
                       "chair": [], "desk": [], "dresser": [], "nightstand": [],
                       "sofa": [], "table": [], "toilet": []}
    count_gt_dict_per_cat = {"bathtub": 0, "bed": 0, "bookshelf": 0,
                       "chair": 0, "desk": 0, "dresser": 0, "nightstand":0,
                       "sofa":0, "table":0, "toilet":0}
    count_pd_dict_per_cat = {"bathtub": 0, "bed": 0, "bookshelf": 0,
                       "chair": 0, "desk": 0, "dresser": 0, "nightstand":0,
                       "sofa":0, "table":0, "toilet":0}
    for image_id in f_list:
        ...
        for txt_3d in pd_list:
            ...
            count_pd_dict_per_cat[cat_pd]+=1
        # pd2_bbox per object
    ...
    print(count_pd_dict_per_cat)
    print(count_gt_dict_per_cat)
